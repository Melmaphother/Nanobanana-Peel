...
Images generated by AI models (like GPT-4o, Gemini, Claude, Grok, DALL-E 3, Midjourney, Flux, Stable Diffusion, and even the latest Nano Banana Pro 🍌) often have two problems:
...
- Pixels within 10% distance of white → **Transparent**
- All other pixels → **Keep original**

## 🔧 Global Installation (Add to Shell)
...
3. **Normalize**: Distance is normalized to [0, 1] range (max distance ≈ 441.67 for RGB)
